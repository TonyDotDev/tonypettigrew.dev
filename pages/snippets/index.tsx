    ...
    <Container customMeta={customMeta}>
      <div className='flex flex-col items-start justify-center max-w-2xl mx-auto mb-16'>
        ...
        <p className='mb-4 text-gray-600 dark:text-gray-400'>
          A colection of useful snippets that I have saved for ease of use. They range from
          CSS/styling to library snippets and hooks. Please feel free to use these in your code! You
          can filter by category or use the search to filter by keyword.
        </p>
          ...
          <Suspense fallback={null}>
            ...
            <div className='grid w-full grid-cols-1 gap-4 my-2 mt-4 sm:grid-cols-2'>
              {!filteredSnippets.length && (
                <p className='mb-4 text-gray-600 dark:text-gray-400'>No snippets found.</p>
              )}
...
export async function getStaticProps({ preview = false }) {
  ...
  const categories: Category[] = await getClient(preview).fetch(allCategoriesQuery);
