...
function AnimatedBars() {
  ...
  return (
    <div className='w-auto flex items-end overflow-hidden h-8'>
...
export default function NowPlaying() {
  ...
  return (
    <div className='flex items-center flex-row mb-8 space-x-0 space-x-4 w-full'>
      {data?.songUrl ? (
        <div
          style={{
            boxShadow:
        ...
        >
          {" "}
          <Image width='44px' height='44px' src={data?.albumImageUrl} alt={data?.album} />
        </div>
      ) : (
