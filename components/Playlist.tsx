...
export default function Track({ ranking, name, description, playlistUrl, playlistImage }: Props) {
  return (
    <div className='flex flex-row pb-4 items-center border-b border-gray-200 dark:border-gray-800 max-w-3xl w-full mt-8'>
      ...
      <div className='flex items-center'>
        <Image className='ml-4' width={44} height={44} alt={name} src={playlistImage} />
